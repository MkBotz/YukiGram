...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        ...
        TURBO("TurboIcon", R.drawable.icon_5_background_sa, R.drawable.icon_white_launcher_foreground, R.string.AppIconTurbo, true),
        NOX("NoxIcon", R.drawable.icon_2_background_sa, R.drawable.icon_white_launcher_foreground, R.string.AppIconNox, true);
