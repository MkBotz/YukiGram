...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        ...
        RAINBOW("RainbowIcon", R.drawable.icon_8_launcher_background, R.drawable.icon_white_launcher_foreground, R.string.AppIconRainbow),
        MONO_BLACK("MonoBlackIcon", R.drawable.iconc_2_background_sa, R.drawable.icon_white_launcher_foreground, R.string.AppIconMonoBlack),
        ARCTIC("ArcticIcon", R.drawable.iconc_3_background_sa, R.drawable.icon_black_launcher_foreground, R.string.AppIconArctic),
        ...
        NOX("NoxIcon", R.drawable.icon_2_background_sa, R.drawable.icon_8_launcher_foreground, R.string.AppIconNox, true);
