...
public class FileLoadOperation {
    ...
    private void updateParams() {
        if (YukiConfig.downloadSpeedBoost == YukiConfig.DOWNLOAD_BOOST_FAST || MessagesController.getInstance(currentAccount).getfileExperimentalParams && !forceSmallChunk) {
            downloadChunkSizeBig = 1024 * 512;
            maxDownloadRequests = 8;
            maxDownloadRequestsBig = 8;
        } else if (YukiConfig.downloadSpeedBoost == YukiConfig.DOWNLOAD_BOOST_EXTREME) {
